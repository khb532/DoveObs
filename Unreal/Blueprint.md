...
![](Resources/image%202.png)

나눗셈은 Float변수로 나누어야 한다. (숫자가 정수로 떨어지는 경우 Integer도 O)

![](Resources/image%203.png)
...
![](Resources/image%204.png)

비교연산의 결과물을 Promote to Value를 통해 변수로 승격시킬 수 있음. (자동으로 변수 생성 가능)
B + 우클릭 = Branch(if-else) 노드 호출


### 디버그

F9으로 브레이크 포인트 생성 및 플레이. F10을 눌러 브레이크 포인트 이후 노드로 넘어가면서 디버그 진행.
...
![](Resources/image%205.png)

재장전 예시

![](Resources/image%206.png)
...
![](Resources/image%207.png)

Flip Flop - A와 B를 반복 실행

Flip Flop의 예시 - (Q를 입력하면 A와 B가 번갈아가면서 출력)

![](Resources/image%208.png)

Branch로 Flip Flop 만들기

![](Resources/image%209.png)
...
![](Resources/image%2010.png)

Max - 입력 값 중에서 가장 큰 수를 반환

Max의 예시

![](Resources/image%2011.png)
...
![](Resources/image%2012.png)

For Loop -

For Loop의 예시

![](Resources/image%2013.png)

For Loop With Break의 예시

![](Resources/image%2014.png)
